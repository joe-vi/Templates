...
The only things that change between stacks are `src/infrastructure/` adapters and the providers in `src/api/dependencies/providers.py`. All other layers are identical.
