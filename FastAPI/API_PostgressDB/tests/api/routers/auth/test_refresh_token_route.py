...
class TestRefreshTokenRoute:
    async def test_returns_200_with_new_token_pair_on_success(
        self, client: AsyncClient, mock_refresh_token_use_case: AsyncMock, make_token_response: auth_contracts.TokenResponse
    ):
        mock_refresh_token_use_case.execute.return_value = (operation_results.LoginResult.SUCCESS, make_token_response)
