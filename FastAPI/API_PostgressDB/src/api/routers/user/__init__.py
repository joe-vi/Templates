...
# One route module per operation; the prefix, tag, and JWT guard are declared
# once here so every user operation stays consistently protected.
...
router.include_router(get_all_users_route.router)
router.include_router(update_user_role_route.router)
